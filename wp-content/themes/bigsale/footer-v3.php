...
<div class="footer-container">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="collapsible mobile-collapsible">
                        ...
                        <div class="block-content block-content-statick toggle-content">
                            <ul class="address">
                                <li class="number-address"><P><span class="street">911 Sounthway Street, Ethan Ellis District<br />San Francisco, United Stated.</span></P></li>
            ...
            <div class="license">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <address>
                            &copy;2017 Copyright. All rights reserved.Design by <a class="active" href="#">Bigsale</a>
                        </address>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="paypal">
    ...
    <a href="#" class="scroll_top" title="<?php esc_html_e( 'Scroll to Top', 'alothemes' ) ?>"><?php esc_html_e( 'Scroll', 'alothemes' ) ?></a>
