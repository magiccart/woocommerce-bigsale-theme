	        ...
	        <div class="header-top">
	            <div class="container">
		            ...
		            <div class="account-link top-mobile">
		                <ul>
		                    <?php
		                    echo '<li class="menu-item first"><a href="'. $support .'" title="">'. "Support" .'</a></li>';
		                    if (is_user_logged_in()){
		                        echo '<li class="menu-item "><a href="'. get_permalink( get_option('woocommerce_myaccount_page_id') ) .'" title="'.esc_html__( 'My Account', 'alothemes' ).'"><span class="pe-7s-user"></span>'.esc_html__('My Account','alothemes').'</a></li>';
