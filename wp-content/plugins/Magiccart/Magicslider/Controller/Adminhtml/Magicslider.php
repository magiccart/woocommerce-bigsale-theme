...
class Magicslider extends Action
{
    ...
    {
        add_submenu_page($this->_menu_slug, __('Slider', "alothemes"), __('Slider', "alothemes"), 'manage_options', $this->_menu_slug . '-slider', array(
            $this,
            'indexAction'
        ));
    }
    ...
    public function setTemplate($template)
    {
        ...
        if (!file_exists($fileTheme))
            $fileTheme = ABSPATH . 'wp-content/plugins/Magiccart/' . $template;
